...
#+begin_src emacs-lisp :tangle no :noweb-ref org-capture-templates
  ...
  (make-meeting-template "mo" "Other" "~/src/org/journal.org" "")
#+end_src
...
#+begin_src emacs-lisp :tangle no :noweb-ref org-capture-templates
  ...
  (make-task-template "to" "Other task" "~/src/org/journal.org")
#+end_src
...
#+begin_src emacs-lisp :noweb yes
  (use-package org-roam
    ...
    (org-capture-mode . org-align-tags)
    :config
...
* Email
 #+begin_src emacs-lisp
   (add-to-list 'load-path "/opt/homebrew/opt/notmuch/share/emacs/site-lisp/notmuch")
   (require 'notmuch)
 #+end_src

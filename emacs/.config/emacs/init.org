...
* Package Management
#+begin_src elisp :results silent :tangle "~/.emacs.d/early-init.el"
...
#+begin_src elisp :results silent
  (use-package org
    ...
    (setq
     ...
     org-agenda-files '("~/git/gtd")
     org-agenda-tags-todo-honor-ignore-options t
     org-agenda-todo-ignore-scheduled 'all
     org-agenda-todo-ignore-deadlines 'all
     org-capture-templates
     '(
       ("t" "Todo" entry (file "~/git/gtd/inbox.org") "* TODO %i%?")
       ("l" "Linked Todo" entry (file "~/git/gtd/inbox.org")
        "* TODO [#A] %?\nSCHEDULED: %(org-insert-time-stamp (org-read-date nil t \"+0d\"))\n%a\n")
       ("n" "Note" entry (file "~/git/gtd/inbox.org") "* %? :NOTE:\n%U\n")
       ("m" "Meeting" entry (file "~/git/gtd/inbox.org")
   ...
   - "
     ...
     org-default-notes-file "~/git/gtd/inbox.org"
     ...
     org-refile-targets
     '(
       ("~/git/gtd/gtd.org" . (:maxlevel . 3))
       ("~/git/gtd/maxwell.org" . (:maxlevel . 3))
       )
...
#+begin_src elisp :results silent
  (use-package org-ref
    ...
    :config
    (require 'doi-utils)
    (setq reftex-default-bibliography '("~/git/bibliography/references.bib"))
    (setq org-ref-default-bibliography '("~/git/bibliography/references.bib")

...
#+begin_src emacs-lisp :tangle no :noweb-ref mu4e-context
  ,(make-mu4e-context
    :name "Zoho"
    :enter-func (lambda () (mu4e-message "Entering zoho context"))
    :leave-func (lambda () (mu4e-message "Leaving zoho context"))
    ;; we match based on the maildir of the message
    :match-func (lambda (msg)
		  (when msg
    ...
    '((user-mail-address . "john@lordpharmaconsulting.com")
	  ...
	  (:maildir "/archive"                    :key ?A)))
      (smtpmail-queue-dir . "~/Maildir/zoho/queue/cur")
     (smtpmail-auth-credentials . '((smtppro.zoho.com 587 john@lordpharmaconsulting.com nil))) 
